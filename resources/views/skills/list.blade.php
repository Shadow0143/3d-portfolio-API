...
<div class="container-xxl flex-grow-1 container-p-y container-fluid">
    ...
    <div class="card">
        <div class="container-xxl d-flex flex-wrap justify-content-between py-2 flex-md-row flex-column mt-5">
            <a href="{{ route('skillsAdd') }}" class="btn btn-outline-primary btn-sm"> + ADD</a>
        </div>
            ...
            <table class="table">
                ...
                <tbody class="table-border-bottom-0">
                    ...
                    <tr id="willremove{{ $value->id }}" class="table-primary text-center">
                        <td><i class="fab fa-angular fa-lg text-danger me-3"></i> <strong>{{ ucfirst($value->skill_name)
                                }}</strong>
                        </td>
                        <td class="text-center">
                            <ul class="list-unstyled">
                                <a href="{{ asset('skillsImage') }}/{{ $value->icons }}" target="_blank">
                                    <li data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="top"
                                        class="avatar avatar-xs pull-up" title="{{ $value->skill_name }}">
                                        <img src="{{ asset('skillsImage') }}/{{ $value->icons }}" alt="Avatar"
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu">
                                    <a class="dropdown-item text-warning"
                                        href="{{ route('skillsEdit', ['id' => $value->id]) }}"><i
...
<script>
    $('.delete').on('click',function(){
            ...
            swal({
                title: "Are you sure?",
                text: "want to remove this skill.",
                type: "warning",
