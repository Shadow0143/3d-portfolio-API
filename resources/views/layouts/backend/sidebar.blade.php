...
<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    <div class="app-brand demo">
        <a href="{{ route('home') }}" class="app-brand-link">
            ...
            <span class="app-brand-text demo menu-text fw-bolder ms-2">Portfolio</span>
        </a>
    ...
    <ul class="menu-inner py-1">
        ...
        <li
            class="menu-item @if( Route::currentRouteName() == 'skillsList' || Route::currentRouteName() == 'skillsAdd' || Route::currentRouteName() == 'skillsEdit') active @endif">
            <a href="{{ route('skillsList') }}" class="menu-link">
                <i class="menu-icon tf-icons bx bx-group"></i>
        ...
        <li
            class="menu-item @if( Route::currentRouteName() == 'resumeList' || Route::currentRouteName() == 'resumeAdd' || Route::currentRouteName() == 'resumeEdit') active @endif">
            <a href="{{ route('resumeList') }}" class="menu-link">
                <i class="menu-icon tf-icons bx bx-group"></i>
        ...
        <li
            class="menu-item @if( Route::currentRouteName() == 'projectsList' || Route::currentRouteName() == 'projectsAdd' || Route::currentRouteName() == 'projectsEdit') active @endif">
            <a href="{{ route('projectsList') }}" class="menu-link">
                <i class="menu-icon tf-icons bx bx-group"></i>
        ...
        <li class="menu-item @if( Route::currentRouteName() == 'contactList' ) active @endif">
            <a href="{{ route('contactList') }}" class="menu-link">
                ...
                <div data-i18n="Basic">Contact Leads</div>
            </a>
        </li>
